...
if (!$asignacion_id || !$dia || !$hora_inicio || !$hora_fin) {
    header("Location: /users/admin/horarios.php?error=faltan_campos&asignacion_id=$asignacion_id");
    exit;
}
...
header("Location: /users/admin/horarios.php?ok=horario_agregado&asignacion_id=$asignacion_id");
exit;
