...
if (!$profesor_id || !$curso_id || !$materia_id) {
    header("Location: ../materias.php?error=faltan_campos&profesor_id=$profesor_id");
    exit;
}
...
if ($existe > 0) {
    header("Location: ../materias.php?error=duplicado&profesor_id=$profesor_id");
    exit;
}
...
header("Location: ../materias.php?ok=asignada&profesor_id=$profesor_id");
exit;
