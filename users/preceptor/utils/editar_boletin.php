    ...
    <main class="flex-1 p-10 max-w-4xl">
        ...
        <?php if ($boletin && $boletin['estado'] == 'borrador'): ?>
            <form method="post">
                ...
                <a href="../boletines.php?curso_id=<?php echo $curso_id; ?>&alumno_id=<?php echo $alumno_id; ?>" class="ml-4 text-gray-600 hover:underline">Volver</a>
            </form>
        <?php elseif ($boletin): ?>
            ...
            <a href="../boletines.php?curso_id=<?php echo $curso_id; ?>&alumno_id=<?php echo $alumno_id; ?>" class="text-gray-600 hover:underline">Volver</a>
        <?php endif; ?>
    </main>
</body>
